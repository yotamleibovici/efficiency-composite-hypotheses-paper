...
\begin{theorem} \label{thm:fwercontrol}
	Assume that the base test and filtration test statistics of every hypothesis are independent of the base test and filtration test statistics of all other hypotheses (\(\left(T^i, S^i\right)\) and \(\left(T^j, S^j\right)\) are independent for every \(i \neq j\)). 
